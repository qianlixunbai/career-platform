...
public class ProfileService {
    ...
    private void apply(UserProfile entity, ProfileRequest request) { entity.setFullName(request.getFullName()); entity.setPhone(request.getPhone()); entity.setAvatarUrl(request.getAvatarUrl()); entity.setCurrentCity(request.getCurrentCity()); entity.setPersonalWebsite(request.getPersonalWebsite()); entity.setGithubUrl(request.getGithubUrl()); }
