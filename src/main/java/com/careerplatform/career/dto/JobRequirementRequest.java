...
public class JobRequirementRequest {
    @NotNull(message = "要求类型不能为空") private RequirementType requirementType;
    private Long skillId;
    @NotBlank(message = "要求内容不能为空") @Size(max = 1000, message = "要求内容长度不能超过1000个字符") private String requirementText;
